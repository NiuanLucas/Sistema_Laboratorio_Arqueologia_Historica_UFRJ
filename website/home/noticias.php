...
<?php
    ...
    $tr2 .= "WHERE pagina_modular_categoria = 'noticias' ";
...
<div class="card mb-4 mt-0 border shadow-sm" style="max-width: 100%;">
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body p-0 m-3">
        ...
        <a class="" href="noticia_mod.php?pg_id=<?php echo $linha['pagina_modular_id'] ?>"> 
        Ver mais </a>
      </div>
    </div>
  </div>
