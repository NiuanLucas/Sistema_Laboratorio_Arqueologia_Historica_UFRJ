...
var texto_3 = "<?php if ( (exibir_caminho('pagina_fixa', 0)[4]) == false ) {
            ...
            echo(str_replace('_', ' ', exibir_caminho('pagina_fixa', 0)[4]));    
            }?>";
...
d1[0].insertAdjacentHTML('beforeBegin', intro + texto_1_link + " / " + texto_2_link + " / " + texto_3_link + end); 
}
     ...
     -->
        ...
        <div class="col-6 col-md text-left mb-0">
            ...
            <ul class="list-unstyled">
              ...
              <li><a class="text-white" href="../login/login.php?pg_id=1" target="_blank">Área do Desenvolvedor</a></li>
            </ul>
        </div>
